...
def easy():
    ...
    easyQ = [
                 ...
                 [
                     "Apa yang akan menjadi output dari ekspresi Python berikut jika nilai x adalah 34? \nprint(“%f”%x)" ,
                    "34.00",
                    "34.000000",
                    "34.0000",
                    "34.00000000"
                ...
                [
                    "Berapa nilai X dalam ekspresi Python berikut? \nX = 2+9*((3*12)-8)/10" ,
                    "30.8",
                    "27.2",
                    "28.4",
                    "30.0"
                ...
                [
                    "Manakah dari berikut ini yang bukan tipe data inti?" ,
                    "Tuples",
                    "Dictionary",
                    "Lists",
                    "Class"
                ...
                [
                    "Manakah dari berikut ini yang mewakili operator XOR bitwise?" ,
                    "&",
                    "!",
                    "^",
                    "|"
...
def medium():
    ...
    mediumQ = [
                [
                    "Manakah dari berikut ini yang bukan merupakan kata kunci penanganan pengecualian dengan Python?",
                     "accept",
                     "finally",
                     "except",
                     "try"
                ...
                [
                    "Misalkan list1 adalah [3, 5, 25, 1, 3], apa itu min(list1)?",
                    "3",
                    "5",
                    "25",
                    "1"
                ...
                [
                    "Misalkan list1 adalah [2, 33, 222, 14, 25], Apa itu list1[-1]?",
                    "Error",
                    "None",
                    "25",
                    "2"
                ...
                [
                    "Manakah dari berikut ini yang tidak valid?",
                    "_a = 1",
                    "__a = 1",
                    "__str__ = 1",
...
def difficult():
    ...
    hardQ = [
                [
       "Semua kata kunci di Python ada di _________",
        "lower case",
        "UPPER CASE",
        "Capitalized",
        "None of the mentioned"
    ...
    [
        "Manakah dari berikut ini yang tidak bisa menjadi variabel?",
        "__init__",
        "in",
        "it",
        "on"
    ...
    [
     "Manakah dari berikut ini yang merupakan tupel Python?",
        "[1, 2, 3]",
        "(1, 2, 3)",
        "{1, 2, 3}",
        "{}"   
    ...
    [
        "Apa yang dikembalikan oleh math.ceil(3.4)?",
        "3",
        "4",
        "4.0",
        "3.0"
    ...
    [
       "Berapa keluaran dari print(math.factorial(4.5))?",
        "24",
        "120",
        "error",
        "24.0"
